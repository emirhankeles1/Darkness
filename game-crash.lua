...
MainFrame.Position = UDim2.new(0.534653485, 0, 0.601489663, 0)
MainFrame.Size = UDim2.new(0, 269, 0, 188)

Launch.Name = 'Launch'
Launch.Parent = MainFrame
Launch.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
Launch.Position = UDim2.new(0, 0, 0.25, 0)
Launch.Size = UDim2.new(0, 269, 0, 111)
Launch.Font = Enum.Font.SciFi
Launch.Text = 'Launch'
...
Launch.MouseButton1Down:connect(function()
    ...
    e1x1x1x1Message.Text = 'dark hub Message'
    ...
    e1x1x1x1Message.MouseButton1Down:connect(function()
        while true do
            ...
            msg.Text =
                'dark hub: MUHAWHAWHAW! NOOBS! I HAVE RETURNED FOR MY REVENGE!'
            wait(6)
            msg:remove()
            wait(3)
            msg = Instance.new('Message')
            msg.Parent = game.Workspace
            msg.Text = 'dark hub: NOW YOU WILL ALL PARISH IN MY FIRE OF DOOM!'
            wait(6)
            msg:remove()
            wait(3)
            msg = Instance.new('Message')
            msg.Parent = game.Workspace
            msg.Text = 'dark hub: I WILL DESTROY YOU ALL! YOU ARE WORTHLESS!'
            wait(6)
            msg:remove()
            wait(3)
            msg = Instance.new('Message')
            msg.Parent = game.Workspace
            msg.Text = 'dark hub: YOU WILL NOT LIVE THROUGH MY DEADLY ATTACKS!'
            wait(6)
            msg:remove()
            wait(3)
            msg = Instance.new('Message')
            msg.Parent = game.Workspace
            msg.Text = 'dark hub: I MIGHT AS WELL CLONE YOU INTO BOTS!'
            wait(6)
            msg:remove()
            wait(3)
            msg = Instance.new('Message')
            msg.Parent = game.Workspace
            msg.Text =
                'dark hub: AND THEN THOSE BOTS WILL DESTROY ROBLOX! HAHAHAHAHA!'
            wait(6)
            msg:remove()
            wait(3)
            msg = Instance.new('Message')
            msg.Parent = game.Workspace
            msg.Text = "dark hub: YOU CAN'T STOP ME! THERES NOTHING YOU CAN DO!"
            wait(6)
            msg:remove()
        end
    end)
    ...
    e1x1x1x1Music.Text = 'dark hub Music'
    ...
    e1x1x1x1Laugh.Text = 'dark hub Laugh'
    ...
    ForceField.MouseButton1Down:connect(function()
        ...
        ForceFieldGUI.Parent = game.Players.LocalPlayer:WaitForChild(
            'PlayerGui'
        )
        ...
        local function DVAWVL_fake_script() -- ForceFieldGUI_2.Script
            ...
            function onClicked(GUI)
                h = script.Parent.Parent.Parent.Parent.Character:findFirstChild(
                    'Humanoid'
                )
                if h ~= nil then
        ...
        local function HYECSMJ_fake_script() -- ForceFieldOFF.Script
            ...
            function onClicked(GUI)
                f = script.Parent.Parent.Parent.Parent.Character:findFirstChild(
                    'ForceField'
                )
                if f ~= nil then
                    f:remove()
        ...
        function dragify(Frame)
            ...
            function updateInput(input)
                ...
                game
                    ...
                    :Create(Frame, TweenInfo.new(0.25), { Position = Position })
                    :Play()
            end
            ...
            game
                :GetService('UserInputService').InputChanged
...
Credits.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
Credits.Size = UDim2.new(0, 269, 0, 50)
Credits.Font = Enum.Font.SciFi
Credits.Text = 'dark hub Gui Launcher'
Credits.TextColor3 = Color3.fromRGB(0, 0, 0)
Credits.TextSize = 14.000

MadeBy.Name = 'MadeBy'
MadeBy.Parent = MainFrame
MadeBy.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
MadeBy.Position = UDim2.new(0, 0, 0.840425551, 0)
MadeBy.Size = UDim2.new(0, 269, 0, 30)
MadeBy.Font = Enum.Font.SciFi
MadeBy.Text = 'By Avali'
